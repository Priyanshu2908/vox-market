...
const page = () => {
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6" style={{ backgroundImage: 'url(https://cdn.pixabay.com/photo/2020/02/17/15/05/market-4856748_1280.jpg)', backgroundSize: 'cover' }}>
